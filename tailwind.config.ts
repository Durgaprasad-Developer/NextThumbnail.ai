...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "cosmic-gradient": "linear-gradient(135deg, #0F0F12 0%, #191935 100%)",
        "button-gradient": "linear-gradient(90deg, #8B5CF6 0%, #EC4899 100%)",
        "glow-gradient": "radial-gradient(circle, rgba(139, 92, 246, 0.15) 0%, rgba(10, 10, 18, 0) 70%)",
